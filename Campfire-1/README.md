...
![0x17.png](/Campfire-1/screenshots/0x17.png)
![ts.png](/Campfire-1/screenshots/ts.png)
...
![powerview.png](/Campfire-1/screenshots/powerview.png)
...
![ts2.png](/Campfire-1/screenshots/ts2.png)
...
```bash
.\PECmd.exe -d "C:\Users\lenovo\Desktop\Campfire-1\Triage\Workstation\2024-05-21T033012_triage_asset\C\Windows\prefetch" --csv "C:\Users\lenovo\Desktop\Campfire-1"
```
...
![pecmd.png](/Campfire-1/screenshots/pecmd.png)

We can search around the timestamp (`2024-05-21 03:18:09`) of Task 1 to spot the tool used to perform the Kerberoasting attack.

![rubeus.png](/Campfire-1/screenshots/rubeus.png)
...
![campfire-1solved.png](/Campfire-1/screenshots/campfire-1solved.png)
